...
* The original package name 'com.example.sample-spring-cloud-microservice' is invalid and this project uses 'com.example.samplespringcloudmicroservice' instead.
